...
public class ColorDemo extends Frame {
    ...
    public static void main(String[] args) {
        ColorDemo appProzor = new ColorDemo();
        appProzor.setSize(new Dimension(200, 200));
        appProzor.setTitle("ColorDemo");
